...
const GameCard: FC<gameCardProps> = ({ titleGame, imgGame, routes }) => {
  return (
    <>
      <Card className="mb-4 card shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] disabled w-64 h-2/4 bg-[#0284c7] glass mx-auto">
        <Card.Body className="items-center text-center">
          <Card.Title className=" h-14">
            <h1 className="font-arena lowercase text-3xl leading-6 text-base-100">
              {titleGame}
            </h1>
          </Card.Title>
